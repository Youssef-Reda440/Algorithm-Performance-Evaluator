...
class InputGenerator:
    ...
    AUTO_SIZES = [500, 1000, 1500, 2000, 2500, 3000]
...
To improve measurement reliability, the system executes the algorithm multiple times and computes the average. It also performs an initial warm-up run to stabilize execution performance.
